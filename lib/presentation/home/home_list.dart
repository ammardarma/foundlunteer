...
import 'package:foundlunteer/presentation/home/home_search.dart';
      ...
      if (jobs.stateJobs == ResultState.loading) {
        ...
        return SafeArea(
          ...
          child: SlidingUpPanel(
            ...
            panelBuilder: (_scrollController) =>
                _scrollingList(_scrollController, jobs),
      ...
      child: RefreshIndicator(
        ...
        child: Container(
          ...
          child:
            ...
            (jobs.jobs.jobs?.isNotEmpty ?? false)
                ? Flexible(
                    child: ListView.builder(
                        padding: EdgeInsets.all(0.0),
                        shrinkWrap: true,
                        controller: _scrollController,
                        itemCount: jobs.jobs.jobs?.length ?? 1,
